...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('pegasus_gnc_launchfile', default_value='simulation/pegasus_sim.launch.py', description='Whether to launch the Pegasus GNC stack alongside the vehicle'),
